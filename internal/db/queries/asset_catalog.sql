...
SELECT * FROM asset_type WHERE company_id = $1 ORDER BY name LIMIT $2 OFFSET $3;
...
SELECT * FROM asset_status WHERE company_id = $1 ORDER BY name LIMIT $2 OFFSET $3;
...
SELECT * FROM catalog_option WHERE company_id = $1 ORDER BY category, value LIMIT $2 OFFSET $3;
