...
SELECT sqlc.arg(parent_id), sqlc.arg(user_id), sqlc.arg(text), sqlc.arg(created_at), sqlc.arg(updated_at)
...
UPDATE fuel_comment AS c SET user_id = sqlc.arg(user_id), text = sqlc.arg(text), updated_at = sqlc.arg(updated_at)
